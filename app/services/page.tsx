    ...
    <>
      ...
      <section className="px-margin-mobile md:px-margin-desktop pb-section-gap pt-12 max-w-container-max mx-auto overflow-hidden">
        <div className="flex flex-col md:flex-row items-end gap-gutter">
          <AnimateOnScroll className="w-full md:w-3/5" direction="left">
          ...
          <AnimateOnScroll className="hidden md:block w-full md:w-2/5 aspect-[4/5] bg-tertiary-fixed relative overflow-hidden" direction="right">
            <img
      ...
      <section className="px-margin-mobile md:px-margin-desktop py-section-gap bg-surface-container-low">
        <div className="max-w-container-max mx-auto">
          <AnimateOnScroll className="mb-section-gap" direction="up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
            ...
            <AnimateOnScroll className="md:col-span-8 group" direction="up" delay={0}>
            ...
            {/* Room Styling */}
            <AnimateOnScroll className="md:col-span-4 flex flex-col justify-between border-t border-outline-variant pt-8" direction="up" delay={0.2}>
              <div>
            ...
            <AnimateOnScroll className="md:col-span-4 border-t border-outline-variant pt-8" direction="up" delay={0}>
            ...
            {/* Decorative Divider */}
            <AnimateOnScroll className="hidden md:block md:col-span-8 border-t border-outline-variant pt-8 relative" direction="up" delay={0.2}>
      ...
      <section className="px-margin-mobile md:px-margin-desktop py-section-gap max-w-container-max mx-auto">
        <AnimateOnScroll className="grid grid-cols-1 md:grid-cols-2 gap-gutter mb-section-gap items-center" direction="up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter">
          {/* Step 1 */}
          <AnimateOnScroll className="relative" direction="up" delay={0}>
          ...
          {/* Step 2 */}
          <AnimateOnScroll className="relative" direction="up" delay={0.2}>
            <div className="mb-8 flex items-baseline">
          ...
          {/* Step 3 */}
          <AnimateOnScroll className="relative" direction="up" delay={0.4}>
            <div className="mb-8 flex items-baseline">
          ...
          {/* Step 4 */}
          <AnimateOnScroll className="relative" direction="up" delay={0.6}>
            <div className="mb-8 flex items-baseline">
      ...
      <section className="px-margin-mobile md:px-margin-desktop py-section-gap bg-primary text-on-primary">
        <AnimateOnScroll className="max-w-container-max mx-auto flex flex-col items-center text-center" direction="up">
