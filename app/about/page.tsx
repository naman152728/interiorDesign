  ...
  return (
    <>
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-section-gap pt-12">
        <AnimateOnScroll className="md:w-2/3" direction="up">
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-section-gap">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
          {/* Image Container */}
          <AnimateOnScroll className="md:col-span-5 relative" direction="right">
          ...
          {/* Bio Content */}
          <AnimateOnScroll className="md:col-start-7 md:col-span-6 mt-12 md:mt-0" direction="left">
      ...
      <section className="bg-surface-container-low py-section-gap">
        <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            {/* Bento Item 1 */}
            <AnimateOnScroll className="bg-surface p-10 flex flex-col justify-between border border-outline-variant/20 h-80" direction="up" delay={0}>
            ...
            {/* Bento Item 2 */}
            <AnimateOnScroll className="bg-primary text-on-primary p-10 flex flex-col justify-between h-80" direction="up" delay={0.2}>
            ...
            {/* Bento Item 3 */}
            <AnimateOnScroll className="bg-surface p-10 flex flex-col justify-between border border-outline-variant/20 h-80" direction="up" delay={0.4}>
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto py-section-gap" id="contact">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
          ...
          {/* Contact Form */}
          <AnimateOnScroll className="bg-surface p-8 md:p-12 border border-outline-variant/20 shadow-sm" direction="left">
