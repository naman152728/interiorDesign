  ...
  return (
    <>
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-16">
        <AnimateOnScroll className="flex flex-col md:flex-row gap-8 border-y border-outline-variant py-8" direction="up">
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-section-gap">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          {/* Project 01 */}
          <AnimateOnScroll className="md:col-span-8" direction="up" delay={0}>
            <Link href="/portfolio/1" className="group cursor-pointer block">
          ...
          {/* Project 02 */}
          <AnimateOnScroll className="md:col-span-4 md:mt-24" direction="up" delay={0.2}>
            <Link href="/portfolio/2" className="group cursor-pointer block">
          ...
          {/* Project 03 */}
          <AnimateOnScroll className="md:col-span-4" direction="up" delay={0}>
            <Link href="/portfolio/3" className="group cursor-pointer block">
          ...
          {/* Project 04 */}
          <AnimateOnScroll className="md:col-span-8 md:-mt-24" direction="up" delay={0.2}>
            <Link href="/portfolio/4" className="group cursor-pointer block">
          ...
          {/* Project 05 */}
          <AnimateOnScroll className="md:col-span-6" direction="up" delay={0}>
            <Link href="/portfolio/5" className="group cursor-pointer block">
          ...
          {/* Project 06 */}
          <AnimateOnScroll className="md:col-span-6 md:mt-24" direction="up" delay={0.2}>
            <Link href="/portfolio/6" className="group cursor-pointer block">
              <div className="relative overflow-hidden aspect-[4/5] bg-surface-container mb-6">
                <img
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
