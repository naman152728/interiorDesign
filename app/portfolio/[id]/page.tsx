    ...
    <>
      ...
      <section className="relative w-full h-[819px] overflow-hidden bg-surface-container-highest -mt-24">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-primary/40 to-transparent flex items-end">
          <AnimateOnScroll className="px-margin-mobile md:px-margin-desktop pb-section-gap max-w-container-max mx-auto w-full" direction="up">
      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          <AnimateOnScroll className="md:col-span-4 border-l border-outline-variant pl-8 mb-12 md:mb-0" direction="left">
          ...
          <AnimateOnScroll className="md:col-span-8" direction="right">
      ...
      <section className="bg-surface-container py-section-gap overflow-hidden">
        <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          <AnimateOnScroll className="text-center mb-16" direction="up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            <AnimateOnScroll className="group relative overflow-hidden bg-surface-dim" direction="up" delay={0}>
              <img
            ...
            <AnimateOnScroll className="group relative overflow-hidden bg-surface-bright" direction="up" delay={0.2}>
              <img
      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <AnimateOnScroll className="mb-16" direction="up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
          {/* Color 1 */}
          <AnimateOnScroll className="bg-[#F9F8F6] p-8 flex flex-col justify-end border border-outline-variant/30" direction="up" delay={0}>
          ...
          {/* Material 1 */}
          <AnimateOnScroll className="md:col-span-2 relative overflow-hidden bg-surface-container" direction="up" delay={0.1}>
            <img
          ...
          {/* Color 2 */}
          <AnimateOnScroll className="bg-[#2C2C2C] p-8 flex flex-col justify-end" direction="up" delay={0.2}>
          ...
          {/* Material 2 */}
          <AnimateOnScroll className="md:col-span-2 relative overflow-hidden bg-surface-container" direction="up" delay={0.3}>
            <img
          ...
          {/* Color 3 */}
          <AnimateOnScroll className="bg-[#D8C3A5] p-8 flex flex-col justify-end" direction="up" delay={0.4}>
          ...
          {/* Material 3 */}
          <AnimateOnScroll className="relative overflow-hidden bg-surface-container" direction="up" delay={0.5}>
            <img
              alt="Belgian Linen"
              className="w-full h-full object-cover"
      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          <AnimateOnScroll className="md:col-span-7 aspect-[4/5] overflow-hidden bg-surface-container" direction="up" delay={0}>
            <img
          ...
          <div className="md:col-span-5 pt-0 md:pt-32 space-y-8">
            <AnimateOnScroll className="aspect-square overflow-hidden bg-surface-container" direction="up" delay={0.2}>
              <img
            ...
            <AnimateOnScroll className="bg-surface-container-low p-12 border-t-2 border-secondary" direction="up" delay={0.4}>
